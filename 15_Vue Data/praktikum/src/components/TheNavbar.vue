      ...
      >
        <ul
          class="
            flex flex-col
            mt-4
            md:flex-row md:mt-0 md:text-sm md:font-medium
          "
        >
        ...
        <div class="md:flex md:justify-between">
          <div class="my-auto mx-3 py-2 flex justify-between">
            <span
              class="
                md:hidden
                text-gray-700
          ...
          <div class="relative mx-3 md:mr-0 md:block py-2">
            <div
              class="
                flex
                absolute
